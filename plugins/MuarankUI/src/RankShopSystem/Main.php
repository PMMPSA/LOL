...
class Main extends PluginBase implements Listener {
    ...
    public function group1($sender){
        ...
        $form = $api->createModalForm(function (Player $sender, $data){
            ...
            $this->getServer()->dispatchCommand(new ConsoleCommandSender(), "setvip " .  $sender->getName() . " VipI 5");               
    ...
    public function group2($sender){
        ...
        $form = $api->createModalForm(function (Player $sender, $data){
            ...
            if($coins >= $cost){
               ...
               $this->pointAPI->reduceMoney($sender, $cost);
               $this->getServer()->dispatchCommand(new ConsoleCommandSender(), "setvip " .  $sender->getName() . " VipII 10");
    ...
    public function group3($sender){  
        ...
        $form = $api->createModalForm(function (Player $sender, $data){
            ...
            if($coins >= $cost){
               ...
               $this->pointAPI->reduceMoney($sender, $cost);
          $this->getServer()->dispatchCommand(new ConsoleCommandSender(), "setvip " .  $sender->getName() . " VipIII 15");
        ...
        $form = $api->createModalForm(function (Player $sender, $data){
            ...
            if($coins >= $cost){
               ...
               $this->pointAPI->reduceMoney($sender, $cost);
               $this->getServer()->dispatchCommand(new ConsoleCommandSender(), "setvip " .  $sender->getName() . " VipIV 20");
	 ...
	 public function group6($sender){
        ...
        $form = $api->createModalForm(function (Player $sender, $data){
            ...
            if($coins >= $cost){
               ...
               $this->pointAPI->reduceMoney($sender, $cost);
		    $this->getServer()->dispatchCommand(new ConsoleCommandSender(), "setvip " .  $sender->getName() . " Master 40");
